...
namespace Igt.InstantsShowcase.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ThemesPrior12MonthsController : InstantsShowcaseControllerBase
    {
        public ThemesPrior12MonthsController(IHttpContextAccessor context, CustomerPortalRepository customerPortal, UserManager<ApplicationUser> userManager) : base(context, customerPortal, userManager) { }
