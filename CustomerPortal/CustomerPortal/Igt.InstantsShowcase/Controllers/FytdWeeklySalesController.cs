...
namespace Igt.InstantsShowcase.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class FytdWeeklySalesController : InstantsShowcaseControllerBase
    {
        public FytdWeeklySalesController(IHttpContextAccessor context, CustomerPortalRepository customerPortal, UserManager<ApplicationUser> userManager) : base(context, customerPortal, userManager) { }
